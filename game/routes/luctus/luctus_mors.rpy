label luctus_prologue:
    ...
    "..."
    "El humo sube y la multitud no se calla,{w=0.3} algo en mi pecho se aprieta como si alguien metiera la mano y cerrara el puño,{w=0.2} y yo sigo sin moverme,{w=0.1} sigo sin moverme, sigo{nw}"
    ...
    "Quiero sacarla de ahí,{w=0.3} tengo que,\n\ntengo que,\n\ntengo que,\n\ntengo que,\n\ntengo que,"
    stop music
    nvl clear
