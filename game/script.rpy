...
label start:
    ...
    "\"Oh Dios mío por favor, por tu divinidad concederme este deseo...{w} Me he enamorado de una mujer, en mi desespero, yo entiendo sus palabras, más ella no las mías y no me da más que un cabeceo.\""
    "En su compasión Dios le respondió" 
    "\"Te otorgare el don del habla para que hábites entre mis hijos.{w} No obstante, no puedo confiar en la integridad de tus palabras.\""
    nvl clear
    ...
    play sound soundrain loop volume 1
    ...
    #Poner flashes de Anaraith muriendose wajajaja
    "\"Oye.\""
    ...
    #Mostrar macizo de flores y poner  un degradez(?) de Anaraith cuerpo completo/cg.
    ...
    #Volver al macizo de flores.
    "Alrededor suyo no hay nada.{w} El camino termina ahí."

    #Flash de la cara asustada de Pavelcito. 
    nvl clear
